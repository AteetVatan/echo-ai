...
from backend.knowledge.self_info_schema import SelfInfoItem  # noqa: E402
from backend.knowledge.self_info_loader import load_self_info_items  # noqa: E402
...
class TestLoadSelfInfoItems:
    ...
    def test_loads_real_self_info_json(self):
        ...
        real_path = PROJECT_ROOT / "backend" / "documents" / "self_info.json"
