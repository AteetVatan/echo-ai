...
Usage:
    # Make sure backend is running first (python backend/run_dev.py)
    pip install websockets  # if not installed
    python backend/tests/test_ws_realtime.py
"""
...
async def main():
    ...
    try:
        ...
        print("❌  Cannot connect — is the backend running? (python backend/run_dev.py)")
        sys.exit(1)
