...
Usage:
    ...
    python -m backend.tools.self_info_cli ask "Tell me about your CV" --index evidence
...
def cmd_build(args: argparse.Namespace) -> None:
    ...
    from backend.knowledge.self_info_vectorstore import build_or_update_self_info_store
...
def cmd_ask(args: argparse.Namespace) -> None:
    ...
    from backend.knowledge.self_info_rag import answer_about_ateet
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        prog="python -m backend.tools.self_info_cli",
    )
